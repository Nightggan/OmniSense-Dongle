...
function Header({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "header", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "header-left", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(StatusDot, { connected, connecting }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "header-model", children: connected ? model : connecting ? "Connecting…" : "Not connected" }),
      firmwareVersion && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "header-meta", children: [
        "fw ",
        firmwareVersion
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "header-right", children: [
      connected && battery != null && /* @__PURE__ */ jsxRuntimeExports.jsx(BatteryBadge, { percent: battery }),
      connected && rssi != null && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "header-meta", title: "Bluetooth signal (dBm)", children: [
        "📶 ",
        rssi,
        " dBm"
      ] }),
      error && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "header-error", children: error }),
...
function StatusDot({ connected, connecting }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: cls, "aria-label": connected ? "Connected" : "Disconnected" });
}
function BatteryBadge({ percent }) {
  const color = percent > 50 ? "var(--color-ok)" : percent > 20 ? "var(--color-warn)" : "var(--color-err)";
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "battery-badge", style: { color }, title: `Battery: ${percent}%`, children: [
    "🔋 ",
    percent,
    "%"
  ] });
}
const ds5 = window.ds5;
...
const RECONNECT_FIELDS = /* @__PURE__ */ new Set([
  "pollingRateMode",
  "controllerMode"
]);
const useConfigStore = create()((set) => ({
  ...
  updateField: (key, value) => set((s) => s.draft ? { draft: { ...s.draft, [key]: value } } : s)
}));
function useIsDirty() {
  return useConfigStore((s) => {
    if (!s.original || !s.draft) return false;
    return Object.keys(s.draft).some(
      (k) => s.draft[k] !== s.original[k]
    );
  });
}
function useNeedsReconnect() {
  return useConfigStore((s) => {
    if (!s.original || !s.draft) return false;
    return [...RECONNECT_FIELDS].some(
      (k) => s.draft[k] !== s.original[k]
    );
  });
}
function Footer({ connected, onRead }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("footer", { className: "footer", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "footer-left", children: [
      needsReconnect && isDirty && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "footer-warn", title: "Polling rate or controller mode changed", children: "⚡ USB reconnect required" }),
      saveError && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "footer-error", children: saveError })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "footer-right", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          onClick: handleSave,
          children: saving ? needsReconnect ? "Reconnecting…" : "Saving…" : "Save to Device"
        }
      )
    ] })
  ] });
...
function SliderRow({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "row slider-row", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "row-label", children: label }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
        className: "slider",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "row-value", children: display })
  ] });
}
function HapticsSection() {
  const { draft, updateField } = useConfigStore();
  if (!draft) return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-title", children: "Haptics" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SliderRow,
      {
        label: "Rumble gain",
...
function SelectRow({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "row select-row", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "row-text", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "row-label", children: [
        label,
        warn && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "reconnect-badge", title: "Changing this requires USB reconnect", children: "⚡" })
      ] }),
      description && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "row-desc", children: description })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "select",
      {
        ...
        disabled,
        onChange: (e) => onChange(Number(e.target.value)),
        children: options.map((opt, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: i, children: opt }, i))
      }
    )
  ] });
}
...
const POLLING_RATE_LABELS = ["250 Hz", "500 Hz", "1000 Hz"];
const CONTROLLER_MODE_LABELS = ["DualSense", "DualSense Edge", "Auto"];
const AUTO_HAPTICS_LABELS = ["Off", "Mix", "Replace"];
function AutoHapticsSection() {
  const { draft, updateField } = useConfigStore();
  if (!draft) return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, {});
  const active = draft.autoHapticsEnable !== 0;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-title", children: "Auto Haptics" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SelectRow,
      {
        label: "Mode",
        ...
        onChange: (v) => updateField("autoHapticsEnable", v)
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SliderRow,
...
function AudioSection() {
  ...
  if (!draft) return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-title", children: "Audio" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SliderRow,
      {
...
function ControllerSection() {
  ...
  if (!draft) return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-title", children: "Controller" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SelectRow,
      {
        ...
        warn: true,
        onChange: (v) => updateField("controllerMode", v)
      }
    ),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SelectRow,
      {
        ...
        warn: true,
        onChange: (v) => updateField("pollingRateMode", v)
      }
    )
  ] });
}
...
function PowerSection() {
  ...
  if (!draft) return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-title", children: "Power" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SliderRow,
      {
...
function ShortcutsSection() {
  ...
  if (!draft) return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-title", children: "Button Shortcuts" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ToggleRow,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "row-separator" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ToggleRow,
      {
...
function LightbarSection() {
  const { draft, updateField } = useConfigStore();
  if (!draft) return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, {});
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "section-card", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "section-title", children: "Lightbar" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      ToggleRow,
      {
...
function useDevice() {
  ...
  reactExports.useEffect(() => {
    const offChanged = ds5.onDeviceChanged((payload) => {
      setState((prev) => ({
        ...
        model: payload.connected ? payload.model ?? prev.model : void 0,
        ...!payload.connected && { battery: null, rssi: null, firmwareVersion: void 0 }
      }));
    });
    const offTelemetry = ds5.onTelemetry((payload) => {
      setState((prev) => ({
        ...prev,
        battery: payload.battery !== void 0 ? payload.battery : prev.battery,
        rssi: payload.rssi !== void 0 ? payload.rssi : prev.rssi
      }));
    });
    ds5.getStatus().then((status) => {
      setState((prev) => ({
        ...prev,
  ...
  const connect = reactExports.useCallback(async () => {
    setState((prev) => ({ ...prev, connecting: true, error: void 0 }));
    try {
...
function App() {
  ...
  reactExports.useEffect(() => {
    ...
    ds5.readConfig().then(setConfig).catch((err) => console.error("[App] readConfig failed:", err));
  }, [device.connected]);
  function handleRead() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "app", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { className: "main-scroll", children: [
      ...
      device.connected && draft && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "sections", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(HapticsSection, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(AutoHapticsSection, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(AudioSection, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ControllerSection, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(PowerSection, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(ShortcutsSection, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(LightbarSection, {})
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Footer, { connected: device.connected, onRead: handleRead })
  ] });
}
function Splash({ error }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "splash", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "splash-icon", children: "🎮" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "splash-title", children: "DS5 Audio Haptics BT" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "splash-sub", children: "Connect your DS5Dongle via USB to begin" }),
    error && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "splash-error", children: error })
  ] });
}
